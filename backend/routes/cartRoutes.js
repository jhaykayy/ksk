...
router.post("/", async (req, res) => {
    ...
    try{
        ...
        if(cart) {
            ...
            if (productIndex > -1 ) {
                // if the product already exists, updte the quantity
...
// @route PUT /api/cart
// @sesc update product qunatity in the cart for a guest or logged-in-user
// @access Public
...
// @desc merge gues cart into user cart on login
// @access private
        ...
        if(guestCart) {
            ...
            if(userCart) {
                ...
                if(productIndex > -1) {
                    ...
                    // otherwise add the add guest item to the cart
